...
if ( ! isset( $_beans_uikit_registered_items ) ) {
	$_beans_uikit_registered_items = array(
		'themes' => array(
			'default'         => BEANS_CSSFRAMEWORK_PATH . 'src/themes/default',
			'almost-flat'     => BEANS_CSSFRAMEWORK_PATH . 'src/themes/almost-flat',
			'gradient'        => BEANS_CSSFRAMEWORK_PATH . 'src/themes/gradient',
			'wordpress-admin' => BEANS_CSSFRAMEWORK_PATH . 'themes/wordpress-admin',
		),
	);
}
